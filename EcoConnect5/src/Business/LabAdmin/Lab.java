...
public class Lab extends Organization {
    ...
    TestDirectory bookedtestlist;

    public Lab(){
        testlist = new TestDirectory();
        bookedtestlist=new TestDirectory();
...
//    }
    ...
    public TestDirectory getBookedtestlist() {
        return bookedtestlist;
    }

    public void setBookedtestlist(TestDirectory bookedtestlist) {
