...
public class ViewCurrentPlans extends javax.swing.JPanel {
    ...
    public ViewCurrentPlans(JPanel userProcessContainer,UserAccount userAccount,EcoSystem business ) {
        initComponents();
...
//            System.out.println(request.getReceiver());
    ...
    private void initComponents() {
        ...
        add(nameTxtField, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 140, 220, -1));

        yrsTxtField.setEditable(false);
        ...
        add(yrsTxtField, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 190, 220, -1));

        monthlTxtField.setEditable(false);
        ...
        add(monthlTxtField, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 240, 220, -1));
        ...
        add(totalTxtField, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 330, 220, -1));

        jLabel3.setFont(new java.awt.Font("Verdana", 1, 12)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(52, 7, 116));
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel3.setText("Plan Name:");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 140, 230, 30));

        jLabel4.setFont(new java.awt.Font("Verdana", 1, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(52, 7, 116));
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel4.setText("Total years of duration:");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 190, 230, 30));

        jLabel5.setFont(new java.awt.Font("Verdana", 1, 12)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(52, 7, 116));
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel5.setText("Monthly premium amount:");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 236, 230, 30));

        jLabel6.setFont(new java.awt.Font("Verdana", 1, 12)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(52, 7, 116));
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel6.setText("Total premium amount:");
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 330, 230, 30));

        jLabel7.setFont(new java.awt.Font("Verdana", 1, 12)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(52, 7, 116));
        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel7.setText("Purchased on:");
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 290, 230, 30));

        purchaseDateTxtField.setEditable(false);
        purchaseDateTxtField.setPreferredSize(new java.awt.Dimension(164, 30));
        add(purchaseDateTxtField, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 290, 220, -1));

        jLabel8.setFont(new java.awt.Font("Verdana", 1, 12)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(52, 7, 116));
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel8.setText("Validity:");
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 380, 220, 30));

        validityTxtField.setEditable(false);
        validityTxtField.setPreferredSize(new java.awt.Dimension(164, 30));
        add(validityTxtField, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 380, 220, -1));

        jLabel10.setFont(new java.awt.Font("Verdana", 1, 12)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(52, 7, 116));
        jLabel10.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel10.setText("Status:");
        add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 430, 220, 30));

        statusTxtField.setEditable(false);
        statusTxtField.setPreferredSize(new java.awt.Dimension(164, 30));
        add(statusTxtField, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 430, 220, -1));
        ...
        add(enterpriseLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 30, 290, 70));

        jButton7.setBackground(new java.awt.Color(52, 7, 116));
        ...
        add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 60, 40));
